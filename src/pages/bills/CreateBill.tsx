        ...
        <div className="bg-card rounded-xl shadow-card p-6">
          ...
          <div className="flex items-center justify-between mb-8 px-4">
            <div className="flex flex-col items-center">
              <div
                className={`w-4 h-4 rounded-full ${getStepStatus(1) === "completed"
                  ? "bg-primary"
            ...
            <div
              className={`flex-1 h-0.5 mx-4 ${currentStep > 1 ? "bg-primary" : "bg-muted"
                }`}
            />
            <div className="flex flex-col items-center">
              <div
                className={`w-4 h-4 rounded-full ${getStepStatus(2) === "completed"
                  ? "bg-primary"
            ...
            <div
              className={`flex-1 h-0.5 mx-4 ${currentStep > 2 ? "bg-primary" : "bg-muted"
                }`}
            />
            <div className="flex flex-col items-center">
              <div
                className={`w-4 h-4 rounded-full ${getStepStatus(3) === "completed"
                  ? "bg-primary"
          ...
          {(!template || template.config.patientEnabled) && (
            <div className="mb-8">
              ...
              <div className="grid grid-cols-5 gap-4 mb-4">
                {/* Render patient fields: show all if no template, or only enabled ones */}
                {(!template || template.config.patientName?.enabled) && (
                  <div>
                ...
                {(!template || template.config.gender?.enabled) && (
                  <div>
                    <Label className="text-sm">
                ...
                {(!template || template.config.phoneNumber?.enabled) && (
                  <div>
                    <Label className="text-sm">
                ...
                {(!template || template.config.patientAddress?.enabled) && (
                  <div>
                    <Label className="text-sm">
          ...
          {(!template || template.config.itemEnabled) && (
            <div className="mb-8">
              <div className="flex items-center gap-3 mb-4">
              ...
              <div className="grid grid-cols-5 gap-4 mb-4">
                ...
                {(!template || template.config.itemName?.enabled) && (
                  <div>
              ...
              <div className="grid grid-cols-5 gap-4 mb-4">
                {(!template || template.config.discount?.enabled) && (
                  <div>
                ...
                {(!template || template.config.mrp?.enabled) && (
                  <div>
                ...
                {(!template || template.config.quantity?.enabled) && (
                  <div>
          ...
          {(!template || template.config.paymentEnabled) && (
            <div className="mb-8">
              <div className="flex items-center gap-3 mb-4">
              ...
              <div className="grid grid-cols-5 gap-4 mb-4">
                {(!template || template.config.amountPaid?.enabled) && (
                  <div>
                ...
                {(!template || template.config.paymentMethod?.enabled) && (
                  <div>
                ...
                {(!template || template.config.totalDiscount?.enabled) && (
                  <div>
                ...
                {(!template || template.config.totalBill?.enabled) && (
                  <div>
                    <Label className="text-sm">
                ...
                {(!template || template.config.outstandingAmount?.enabled) && (
                  <div>
